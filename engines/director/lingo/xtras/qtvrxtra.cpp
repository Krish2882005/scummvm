...
static MethodProto xlibMethods[] = {
	...
	{ "QTVRSetClickLoc",				QtvrxtraXtra::m_QTVRSetClickLoc,		 1, 1,	500 },
	...
	{ "QTVRSetHotSpotID",				QtvrxtraXtra::m_QTVRSetHotSpotID,		 1, 1,	500 },
	...
	{ "QTVRSetWarpMode",				QtvrxtraXtra::m_QTVRSetWarpMode,		 1, 1,	500 },
	{ "QTVRCollapseToHotSpotRgn",				QtvrxtraXtra::m_QTVRCollapseToHotSpotRgn,		 0, 0,	500 },
	{ "QTVRZoomOutEffect",				QtvrxtraXtra::m_QTVRZoomOutEffect,		 3, 3,	500 },
	...
	{ "QTVRSetMouseDownHandler",				QtvrxtraXtra::m_QTVRSetMouseDownHandler,		 1, 1,	500 },
	{ "QTVRGetMouseOverHandler",				QtvrxtraXtra::m_QTVRGetMouseOverHandler,		 0, 0,	500 },
	{ "QTVRSetMouseOverHandler",				QtvrxtraXtra::m_QTVRSetMouseOverHandler,		 1, 1,	500 },
	{ "QTVRGetMouseStillDownHandler",				QtvrxtraXtra::m_QTVRGetMouseStillDownHandler,		 0, 0,	500 },
	{ "QTVRSetMouseStillDownHandler",				QtvrxtraXtra::m_QTVRSetMouseStillDownHandler,		 1, 1,	500 },
	{ "QTVRGetNodeLeaveHandler",				QtvrxtraXtra::m_QTVRGetNodeLeaveHandler,		 0, 0,	500 },
	{ "QTVRSetNodeLeaveHandler",				QtvrxtraXtra::m_QTVRSetNodeLeaveHandler,		 1, 1,	500 },
	{ "QTVRGetPanZoomStartHandler",				QtvrxtraXtra::m_QTVRGetPanZoomStartHandler,		 0, 0,	500 },
	{ "QTVRSetPanZoomStartHandler",				QtvrxtraXtra::m_QTVRSetPanZoomStartHandler,		 1, 1,	500 },
	{ "QTVRGetRolloverHotSpotHandler",				QtvrxtraXtra::m_QTVRGetRolloverHotSpotHandler,		 0, 0,	500 },
	{ "QTVRSetRolloverHotSpotHandler",				QtvrxtraXtra::m_QTVRSetRolloverHotSpotHandler,		 1, 1,	500 },
...
bool QtvrxtraXtraObject::processEvent(Common::Event &event) {
	...
	// TODO: This is NOT the correct place to execute the handler
	if (!_mouseOverHandler.empty())
		g_lingo->executeHandler(_mouseOverHandler);
...
void QtvrxtraXtra::m_QTVRGetNodeID(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRGetNodeID", nargs);
	ARGNUMCHECK(0);
...
void QtvrxtraXtra::m_QTVRSetNodeID(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRSetNodeID", nargs);
	ARGNUMCHECK(1);

	QtvrxtraXtraObject *me = (QtvrxtraXtraObject *)g_lingo->_state->me.u.obj;

	me->_currentNode = me->_video->getNodeData(g_lingo->pop().asInt());
}

void QtvrxtraXtra::m_QTVRGetNodeName(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRGetNodeName", nargs);
	ARGNUMCHECK(0);
...
void QtvrxtraXtra::m_QTVRSetQuality(int nargs) {
	...
	me->_quality = atoi(g_lingo->pop().asString().c_str());
}
...
void QtvrxtraXtra::m_QTVRGetVisible(int nargs) {
	...
	if (me->_visible)
		g_lingo->push(Common::String("visible"));
	else
		g_lingo->push(Common::String("invisible"));
}
...
void QtvrxtraXtra::m_QTVRSetVisible(int nargs) {
	...
	if (visiblityStr.equalsIgnoreCase("visible")) {
		...
		Common::String errorStr = "QtvrxtraXtra::m_QTVRSetVisible(): Invalid visibility string: " + visiblityStr;
...
void QtvrxtraXtra::m_QTVRNudge(int nargs) {
	...
	if (!(direction.equalsIgnoreCase("left") || direction.equalsIgnoreCase("right") ||
		...
		Common::String errorMessage = "Invalid direction: " + direction;
...
void QtvrxtraXtra::m_QTVRGetMouseOverHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRGetMouseOverHandler", nargs);
	ARGNUMCHECK(0);
...
void QtvrxtraXtra::m_QTVRSetMouseOverHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRSetMouseOverHandler", nargs);
	ARGNUMCHECK(1);
...
void QtvrxtraXtra::m_QTVRGetMouseStillDownHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRGetMouseStillDownHandler", nargs);
	ARGNUMCHECK(0);
...
void QtvrxtraXtra::m_QTVRSetMouseStillDownHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRSetMouseStillDownHandler", nargs);
	ARGNUMCHECK(1);
...
void QtvrxtraXtra::m_QTVRGetNodeLeaveHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRGetNodeLeaveHandler", nargs);
	ARGNUMCHECK(0);
...
void QtvrxtraXtra::m_QTVRSetNodeLeaveHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRSetNodeLeaveHandler", nargs);
	ARGNUMCHECK(1);
...
void QtvrxtraXtra::m_QTVRGetPanZoomStartHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRGetPanZoomStartHandler", nargs);
	ARGNUMCHECK(0);
...
void QtvrxtraXtra::m_QTVRSetPanZoomStartHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRSetPanZoomStartHandler", nargs);
	ARGNUMCHECK(1);
...
void QtvrxtraXtra::m_QTVRGetRolloverHotSpotHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRGetRolloverHotSpotHandler", nargs);
	ARGNUMCHECK(0);
...
void QtvrxtraXtra::m_QTVRSetRolloverHotSpotHandler(int nargs) {
	g_lingo->printSTUBWithArglist("QtvrxtraXtra::m_QTVRSetRolloverHotSpotHandler", nargs);
	ARGNUMCHECK(1);
...
void QtvrxtraXtra::m_QTVRPassMouseDown(int nargs) {
	...
	Common::Point mousePos = g_director->getEventManager()->getMousePos();

	me->_video->handleMouseButton(true, mousePos.x, mousePos.y);
}
